# This is for generating the MST-unequal locations in our simulation.
...
#We have already provided "try_nonperfect_svc_pattern.mat" in the file "location_generation", 
#following code is not necessary.
writeMat('D:/try_nonperfect_svc_pattern.mat', lon=cbind(x),lat=cbind(y),beta=beta_value)
