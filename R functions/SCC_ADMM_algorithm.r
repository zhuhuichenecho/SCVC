...
SCC_ADMM=function(temp_matrix,B,theta,lambda1_S,lambda1_I,tol=10^{-8},maxit=500)
{
...
res=z-B%*%a_vector
objective_value=(1/n)*0.5*sum(res^2)+sum(a_dif_threh)

if(track=="True")
{
print(1000*c(((1/n)*0.5*sum(res^2)),sum(a_dif_threh)))
}
}
