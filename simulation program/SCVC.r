...
BICC=BIC_ADMM_empirical(lambda1_S_seq,lambda2_S_seq,lambda1_I_seq,lambda2_I_seq,B,BB,E,"False",500)
...
BICC_SCVC=BIC_ADMM_empirical(lambda1_S,lambda2_S,lambda1_I,lambda2_I,B,BB,E,"False",500)
...
#compute the results for SCVC method
mean(MSE_svc_beta)
aa=MSE_svc_beta
